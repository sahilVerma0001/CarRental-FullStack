...
export default function ManageCars(){
    ...
    return (
        <div className="px-4 pt-10 md:px-10 w-full">
            <Title title="Manage Cars" subTitle="View all listed cars, update their Details and remove them from the Booking Platform." />
                            ...
                            <tr key={index} className="border-t border-borderColor" >
                                <td className="p-3 flex items-center gap-3">
                                    ...
                                    <div className="max-md:hidden">
                                        ...
                                        <p className="text-xs text-gray-500">{car.seating_capacity} &bull; {car.transmission}</p>
                                    </div>
                                </td>

                                <td className="px-3 max-md:hidden">{car.category}</td>
